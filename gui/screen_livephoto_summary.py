...
from workers.live_photo_worker import LivePhotoResult
...
class LivePhotoSummaryScreen(QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        subtitle = QLabel("라이브 포토에서 정지 이미지 추출이 모두 완료되었습니다.")
    ...
    def load_result(self, result: LivePhotoResult) -> None:
        self._card_success.set_value(result.processed)
